       ...
       <div className='max-w-md shadow-md px-8 py-6 bg-white rounded-lg'>
        ...
        <form onSubmit={onSubmitHandler}>
            <div className='mb-3 min-w-72'>
                ...
                <input onChange={(e)=>setEmail(e.target.value)} value={email} className='border border-gray-300 w-full rounded-md px-3 py-2 outline-none' type="email" placeholder='you@example.com' />
            </div>
            <div className='mb-3 min-w-72'>
                <p className='text-sm font-medium text-gray-700 mb-2'>Your Password</p>
                <input onChange={(e)=>setPassword(e.target.value)} value={password} className='border border-gray-300 w-full rounded-md px-3 py-2 outline-none' type="password" placeholder='password' />
            </div>
