       ...
       <form className='flex flex-col gap-3 w-full items-start'>
        ...
        <div className='w-full'>
          ...
          <div className='w-full'>
            ...
            <textarea className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='write product description here' required/>
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8 '>
            ...
            <div>
                ...
                <input className='w-full sm:w-[120px] px-3 py-2' type="number" placeholder='25'/>
            </div>
        </div>
        ...
        <div>
            ...
            <div className='flex gap-3'>
                <div>
                 ...
                 <div>
                    <p className='bg-slate-200 px-3 py-1 cursor-pointer'>XS</p>
                </div>
            </div>
        </div>
